...
void
safetyNoteControlContact(uint32_t nowMs)
{
	lastControlContactMs = nowMs;
}
...
uint16_t
safetyUpdate(const SensorData & data, uint32_t nowMs)
{
...
bool
safetyCanMove(MotionCommand command)
{
