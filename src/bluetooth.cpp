...
BluetoothCommand decodeCommand(char value) {
    ...
    switch (value) {
        ...
        case '0':
            return BluetoothCommand::SPEED_0;
        case '1':
            return BluetoothCommand::SPEED_1;
        case '2':
            return BluetoothCommand::SPEED_2;
        case '3':
            return BluetoothCommand::SPEED_3;
        case '4':
            return BluetoothCommand::SPEED_4;
        case '5':
            return BluetoothCommand::SPEED_5;
        case '6':
            return BluetoothCommand::SPEED_6;
        case '7':
            return BluetoothCommand::SPEED_7;
        case '8':
            return BluetoothCommand::SPEED_8;
        case '9':
            return BluetoothCommand::SPEED_9;
        default:
...
void bluetoothSendHelp() {
    bluetoothSerial.println(F("CMD:F/W,B,L/A,R/D,S,T,X,C,P,H,J,U,0-9,?"));
}
