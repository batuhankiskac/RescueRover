...
void printGasState(Print& output, GasState state) {
    switch (state) {
        ...
        case GasState::WARNING:
            ...
            break;
        case GasState::CRITICAL:
            output.print(F("CRITICAL"));
            break;
    }
}
...
void printRobotState(Print& output, RobotState state) {
    switch (state) {
        case RobotState::STARTUP:
            output.print(F("STARTUP"));
            break;
        case RobotState::IDLE:
            output.print(F("IDLE"));
            break;
        case RobotState::DRIVING:
            output.print(F("DRIVING"));
            break;
...
const __FlashStringHelper* alertText(AlertCode code) {
    switch (code) {
        case AlertCode::OBSTACLE:
            return F("ALERT:OBSTACLE");
        case AlertCode::GAS_WARNING:
            return F("ALERT:GAS_WARNING");
        case AlertCode::GAS_CRITICAL:
            return F("ALERT:GAS_CRITICAL");
        case AlertCode::TEMP_WARNING:
            return F("ALERT:TEMPERATURE_WARNING");
        case AlertCode::TEMP_CRITICAL:
            return F("ALERT:TEMPERATURE_CRITICAL");
        case AlertCode::SOUND_DETECTED:
            return F("ALERT:SOUND_DETECTED");
        case AlertCode::MOTION_DETECTED:
            return F("ALERT:MOTION_DETECTED");
        case AlertCode::TILT_WARNING:
            return F("ALERT:TILT_WARNING");
        case AlertCode::TILT_CRITICAL:
            return F("ALERT:TILT_CRITICAL");
        case AlertCode::COMMAND_TIMEOUT:
            return F("ALERT:COMMAND_TIMEOUT");
        case AlertCode::EMERGENCY_STOP:
            return F("ALERT:EMERGENCY_STOP");
        case AlertCode::EMERGENCY_CLEARED:
            return F("ALERT:EMERGENCY_CLEARED");
        case AlertCode::CLEAR_REJECTED:
            return F("ALERT:CLEAR_REJECTED");
        case AlertCode::FORWARD_BLOCKED:
            return F("ALERT:FORWARD_BLOCKED");
        case AlertCode::MOTION_BLOCKED:
            return F("ALERT:MOTION_BLOCKED");
        case AlertCode::ULTRASONIC_FAULT:
            return F("ALERT:ULTRASONIC_FAULT");
    }
